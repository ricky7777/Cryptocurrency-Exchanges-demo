 ...
 * two data source use MediatorLiveData
 ...
 */
class ExchangeRepository2 : IRepository {
    ...
    private val mediatorLiveData = MediatorLiveData<Pair<Map<String, Float>, Map<String, Float>>>()

    val exchangeData: LiveData<Pair<Map<String, Float>, Map<String, Float>>> = _exchangeData
    init {
        mediatorLiveData.addSource(_exchangeData) { data ->
            ...
            mediatorLiveData.value = Pair(spotMap, futureMap)
        }
    }
